...
from .trait_handlers import (
    TraitHandler, TraitInstance, TraitFunction, TraitCoerceType, TraitCastType,
    TraitEnum, TraitCompound, TraitMap, TraitString, ThisClass, TraitType,
    _arg_count, _read_only, _write_only, _undefined_get, _undefined_set)
...
PythonTypes = (str, str, int, int, float, complex, list, tuple, dict,
               FunctionType, MethodType, type, NoneType)

if sys.version_info[0] < 3:
    from types import InstanceType, ClassType
    PythonTypes = PythonTypes[:-2] + (InstanceType, ClassType
                                      ) + PythonTypes[2:]
...
def Property(fget=None,
    ...
    trait.property(fget,
                   _arg_count(fget), fset, _arg_count(fset), fvalidate, n)
    trait.handler = handler
